...
(JDIMENSION
img_width,
JSAMPARRAY input_buf, JSAMPIMAGE
output_buf,
...
jsimd_extrgb_ycc_convert_neon_slowld3
(JDIMENSION
img_width,
JSAMPARRAY input_buf, JSAMPIMAGE
output_buf,
...
jsimd_extbgr_ycc_convert_neon_slowld3
(JDIMENSION
img_width,
JSAMPARRAY input_buf, JSAMPIMAGE
output_buf,
...
jsimd_rgb_ycc_convert_mips_dspr2
(JDIMENSION
img_width,
JSAMPARRAY input_buf, JSAMPIMAGE
output_buf,
...
jsimd_extrgb_ycc_convert_altivec
(JDIMENSION
img_width,
JSAMPARRAY input_buf, JSAMPIMAGE
output_buf,
...
jsimd_extrgbx_ycc_convert_altivec
(JDIMENSION
img_width,
JSAMPARRAY input_buf, JSAMPIMAGE
output_buf,
...
jsimd_extbgr_ycc_convert_altivec
(JDIMENSION
img_width,
JSAMPARRAY input_buf, JSAMPIMAGE
output_buf,
...
jsimd_extbgrx_ycc_convert_altivec
(JDIMENSION
img_width,
JSAMPARRAY input_buf, JSAMPIMAGE
output_buf,
...
jsimd_extxrgb_ycc_convert_altivec
(JDIMENSION
img_width,
JSAMPARRAY input_buf, JSAMPIMAGE
output_buf,
...
jsimd_rgb_gray_convert_mips_dspr2
(JDIMENSION
img_width,
JSAMPARRAY input_buf, JSAMPIMAGE
output_buf,
...
(JDIMENSION
out_width,
JSAMPIMAGE input_buf, JDIMENSION
input_row,
...
jsimd_ycc_extbgr_convert_neon_slowst3
(JDIMENSION
out_width,
JSAMPIMAGE input_buf, JDIMENSION
input_row,
...
jsimd_ycc_rgb_convert_mips_dspr2
(JDIMENSION
out_width,
JSAMPIMAGE input_buf, JDIMENSION
input_row,
...
jsimd_ycc_extrgb_convert_altivec
(JDIMENSION
out_width,
JSAMPIMAGE input_buf, JDIMENSION
input_row,
...
jsimd_ycc_extrgbx_convert_altivec
(JDIMENSION
out_width,
JSAMPIMAGE input_buf, JDIMENSION
input_row,
...
jsimd_ycc_extbgr_convert_altivec
(JDIMENSION
out_width,
JSAMPIMAGE input_buf, JDIMENSION
input_row,
...
jsimd_ycc_extbgrx_convert_altivec
(JDIMENSION
out_width,
JSAMPIMAGE input_buf, JDIMENSION
input_row,
...
jsimd_ycc_extxbgr_convert_altivec
(JDIMENSION
out_width,
JSAMPIMAGE input_buf, JDIMENSION
input_row,
...
jsimd_ycc_extxrgb_convert_altivec
(JDIMENSION
out_width,
JSAMPIMAGE input_buf, JDIMENSION
input_row,
...
jsimd_c_null_convert_mips_dspr2
(JDIMENSION
img_width,
JSAMPARRAY input_buf, JSAMPIMAGE
output_buf,
...
jsimd_h2v1_downsample_mips_dspr2
(JDIMENSION
image_width,
int max_v_samp_factor,
		JDIMENSION
...
jsimd_h2v2_downsample_mips_dspr2
(JDIMENSION
image_width,
int max_v_samp_factor,
		JDIMENSION
...
jsimd_h2v2_smooth_downsample_mips_dspr2
(JSAMPARRAY
input_data,
JSAMPARRAY output_data,
		JDIMENSION
v_samp_factor,
int max_v_samp_factor,
int smoothing_factor, JDIMENSION
width_blocks,
...
jsimd_int_upsample_mips_dspr2
(UINT8
h_expand,
UINT8 v_expand, JSAMPARRAY
input_data,
JSAMPARRAY *output_data_ptr, JDIMENSION
output_width,
int max_v_samp_factor
);
...
jsimd_h2v1_extrgb_merged_upsample_mmx
(JDIMENSION
output_width,
JSAMPIMAGE input_buf,
		JDIMENSION
...
jsimd_h2v1_extrgbx_merged_upsample_mmx
(JDIMENSION
output_width,
JSAMPIMAGE input_buf,
		JDIMENSION
...
jsimd_h2v1_extxbgr_merged_upsample_mmx
(JDIMENSION
output_width,
JSAMPIMAGE input_buf,
		JDIMENSION
...
jsimd_h2v2_extrgb_merged_upsample_mmx
(JDIMENSION
output_width,
JSAMPIMAGE input_buf,
		JDIMENSION
...
jsimd_h2v2_extrgbx_merged_upsample_mmx
(JDIMENSION
output_width,
JSAMPIMAGE input_buf,
		JDIMENSION
...
jsimd_h2v2_extbgr_merged_upsample_mmx
(JDIMENSION
output_width,
JSAMPIMAGE input_buf,
		JDIMENSION
...
jsimd_h2v2_extbgrx_merged_upsample_mmx
(JDIMENSION
output_width,
JSAMPIMAGE input_buf,
		JDIMENSION
...
jsimd_h2v2_extxbgr_merged_upsample_mmx
(JDIMENSION
output_width,
JSAMPIMAGE input_buf,
		JDIMENSION
...
jsimd_h2v2_extxrgb_merged_upsample_mmx
(JDIMENSION
output_width,
JSAMPIMAGE input_buf,
		JDIMENSION
...
jsimd_convsamp_float_3dnow
(JSAMPARRAY
sample_data,
JDIMENSION start_col, FAST_FLOAT
*workspace);
...
jsimd_convsamp_float_mips_dspr2
(JSAMPARRAY
sample_data,
JDIMENSION start_col, FAST_FLOAT
*workspace);
...
jsimd_fdct_islow_sse2 (DCTELEM
*data);

EXTERN(void)

jsimd_fdct_islow_neon (DCTELEM
*data);

EXTERN(void)

jsimd_fdct_islow_mips_dspr2 (DCTELEM
*data);

EXTERN(void)

jsimd_fdct_islow_altivec (DCTELEM
*data);

/* Fast Integer Forward DCT */
EXTERN(void)

jsimd_fdct_ifast_mmx (DCTELEM
*data);
...
jsimd_fdct_ifast_sse2 (DCTELEM
*data);

EXTERN(void)

jsimd_fdct_ifast_neon (DCTELEM
*data);

EXTERN(void)

jsimd_fdct_ifast_mips_dspr2 (DCTELEM
*data);

EXTERN(void)

jsimd_fdct_ifast_altivec (DCTELEM
*data);

/* Floating Point Forward DCT */
EXTERN(void)

jsimd_fdct_float_3dnow (FAST_FLOAT
*data);
...
jsimd_fdct_float_sse (FAST_FLOAT
*data);
...
(JCOEFPTR
coef_block,
FAST_FLOAT *divisors, FAST_FLOAT
*workspace);
...
jsimd_quantize_float_mips_dspr2
(JCOEFPTR
coef_block,
FAST_FLOAT *divisors, FAST_FLOAT
*workspace);
...
jsimd_idct_12x12_pass1_mips_dspr2
(JCOEFPTR
coef_block,
void *dct_table,
int *workspace
...
jsimd_idct_12x12_pass2_mips_dspr2
		(int *workspace, int *output);

/* Slow Integer Inverse DCT */
EXTERN(void)

jsimd_idct_islow_mmx
		(void *dct_table, JCOEFPTR coef_block, JSAMPARRAY output_buf,
		 JDIMENSION output_col);
...
jsimd_idct_ifast_cols_mips_dspr2
(JCOEF
*inptr,
IFAST_MULT_TYPE *quantptr, DCTELEM
*wsptr,
...
jsimd_idct_ifast_rows_mips_dspr2
(DCTELEM
*wsptr,
...
jsimd_huff_encode_one_block_neon_slowtbl
		(void *state, JOCTET *buffer, JCOEFPTR block, int last_dc_val,
		 c_derived_tbl *dctbl, c_derived_tbl *actbl);
