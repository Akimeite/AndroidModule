...
MEMCOPY((*htblptr)
->huffval, val, nsymbols * sizeof(UINT8));
...
&dc_huff_tbl_ptrs[0], bits_dc_luminance,
val_dc_luminance);
add_huff_table(cinfo,
&ac_huff_tbl_ptrs[0], bits_ac_luminance,
val_ac_luminance);
add_huff_table(cinfo,
&dc_huff_tbl_ptrs[1], bits_dc_chrominance,
val_dc_chrominance);
add_huff_table(cinfo,
&ac_huff_tbl_ptrs[1], bits_ac_chrominance,
val_ac_chrominance);
}
