...
open class DjangoApp : Application() {
	...
	private fun initDeviceInfo() {
		...
		sbDebugInfo.append("设备是否是平板: ").append(if (DeviceUtils.isTablet()) "是" else "否").append("\n")
		sbDebugInfo.append("设备是否是模拟器: ").append(if (DeviceUtils.isEmulator()) "是" else "否").append("\n")
		...
		sbDebugInfo.append("设备SIM卡是否准备好: ").append(if (PhoneUtils.isSimCardReady()) "是" else "否").append("\n")
		sbDebugInfo.append("设备SIM卡运营商名称: ").append(PhoneUtils.getSimOperatorName()).append(" ").append(PhoneUtils.getSimOperatorByMnc())
			.append("\n")
