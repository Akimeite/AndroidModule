...
//		initDeviceInfo()
	...
	private fun initDeviceInfo() {
		...
		sbDebugInfo.append("App是否是debug版本: ").append(if (AppUtils.isAppDebug()) "是" else "否")
				.append("\n")
		sbDebugInfo.append("App是否是系统应用: ").append(if (AppUtils.isAppSystem()) "是" else "否")
				.append("\n")
		...
		sbDebugInfo.append("设备是否root: ").append(if (DeviceUtils.isDeviceRooted()) "是" else "否")
				.append("\n")
		sbDebugInfo.append("设备adb是否可用: ").append(if (DeviceUtils.isAdbEnabled()) "是" else "否")
				.append("\n")
		...
		sbDebugInfo.append("设备是否是平板: ").append(if (DeviceUtils.isTablet()) "是" else "否")
				.append("\n")
		sbDebugInfo.append("设备是否是模拟器: ").append(if (DeviceUtils.isEmulator()) "是" else "否")
				.append("\n")
		sbDebugInfo.append("设备是否是手机: ").append(if (PhoneUtils.isPhone()) "是" else "否").append("\n")
		sbDebugInfo.append("设备码: ").append(PhoneUtils.getDeviceId()).append("\n")
		sbDebugInfo.append("设备序列号: ").append(PhoneUtils.getSerial()).append("\n")
		sbDebugInfo.append("设备IMEI码: ").append(PhoneUtils.getIMEI()).append("\n")
		sbDebugInfo.append("设备MEID码: ").append(PhoneUtils.getMEID()).append("\n")
		sbDebugInfo.append("设备IMSI码: ").append(PhoneUtils.getIMSI()).append("\n")
		sbDebugInfo.append("设备SIM卡是否准备好: ").append(if (PhoneUtils.isSimCardReady()) "是" else "否")
				.append("\n")
		sbDebugInfo.append("设备SIM卡运营商名称: ").append(PhoneUtils.getSimOperatorName()).append(" ")
				.append(PhoneUtils.getSimOperatorByMnc())
				.append("\n")
		sbDebugInfo.append("设备屏幕宽度: ").append(ScreenUtils.getScreenWidth()).append("px")
				.append("\n")
		sbDebugInfo.append("设备屏幕高度: ").append(ScreenUtils.getScreenHeight()).append("px")
				.append("\n")
		sbDebugInfo.append("设备状态栏高度: ").append(BarUtils.getStatusBarHeight()).append("px")
				.append("\n")
		if (BarUtils.isSupportNavBar()) sbDebugInfo.append("设备导航栏高度: ").append(BarUtils.getNavBarHeight()).append(
				"px"
		).append("\n")
