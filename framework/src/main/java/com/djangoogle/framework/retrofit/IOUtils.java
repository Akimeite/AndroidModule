...
/**
 * Created by Djangoogle on 2019/04/28 11:50 with Android Studio.
 */
public class IOUtils {
	...
	public static byte[] toByteArray(CharSequence input, String encoding) throws UnsupportedEncodingException {
		if (input == null) { return new byte[0]; } else { return input.toString().getBytes(encoding); }
	}
	...
	public static long getDirSize(String path) {
		...
		if (Build.VERSION.SDK_INT >= 18) { return getStatFsSize(stat, "getBlockSizeLong", "getAvailableBlocksLong"); } else {
